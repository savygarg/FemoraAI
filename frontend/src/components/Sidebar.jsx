...
const NAV_ITEMS = [
...

  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
        <path
          d="M5 3h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2zm3 4v2h8V7H8zm0 4v2h8v-2H8zm0 4v2h5v-2H8z"
          fill="currentColor"
        />
      </svg>
    ),
    ...
    <>
      ...
      >
        ...
        <div className="sidebar__footer">
          ...
          <button
            type="button"
            className="sidebar__logout btn btn--secondary btn--full"
